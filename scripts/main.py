...
if __name__ == "__main__":
    ...
    df_train_merged_path, df_validate_merged_path, df_test_merged_path = logs_path + "df_train_merged.csv", logs_path + "df_validate_merged.csv", logs_path + "df_test_merged.csv"
